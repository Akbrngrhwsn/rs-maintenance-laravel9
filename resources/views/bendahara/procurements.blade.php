                ...
                <div class="p-6 border-b border-gray-100">
                    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                        <div class="flex items-center gap-3">
                            <a href="{{ route('bendahara.procurements.index', array_merge(request()->all(), ['tab' => 'pending'])) }}" class="px-3 py-1 rounded-md {{ (isset($tab) && $tab==='pending') || !isset($tab) ? 'bg-blue-600 text-white' : 'bg-gray-100 text-gray-700' }}">Belum Disetujui</a>
                            <a href="{{ route('bendahara.procurements.index', array_merge(request()->all(), ['tab' => 'history'])) }}" class="px-3 py-1 rounded-md {{ isset($tab) && $tab==='history' ? 'bg-blue-600 text-white' : 'bg-gray-100 text-gray-700' }}">Riwayat</a>
                        </div>
