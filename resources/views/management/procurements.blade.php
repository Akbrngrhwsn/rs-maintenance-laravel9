                        ...
                        <tbody class="divide-y divide-gray-100">
                            @forelse($procurements as $proc)
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-4 align-top text-center">
                                        @if($proc->status == 'submitted_to_management')
                                            <div class="flex items-center justify-center gap-2">
                                                <form action="{{ route('management.procurements.approve', $proc->id) }}" method="POST">
                                                    @csrf
                                                    @method('PATCH')
                                                    <button type="submit" 
                                                ...
                                                <div id="reject-modal-{{ $proc->id }}" class="hidden fixed inset-0 z-50 flex items-center justify-center">
                                                    ...
                                                    <div class="bg-white rounded-xl shadow-2xl max-w-xl w-full relative z-10 overflow-hidden transform transition-all m-4">
                                                        ...
                                                        <form action="{{ route('management.procurements.reject', $proc->id) }}" method="POST">
                                                            @csrf
                                                            @method('PATCH')
                                                            <div class="p-6">
